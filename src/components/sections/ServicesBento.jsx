...
export default function ServicesBento() {
  return (
    <section id="services" className="py-20 md:py-24 bg-[#FAF8F5] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="mb-12 md:mb-20 flex flex-col lg:flex-row justify-between lg:items-end gap-6 md:gap-10">
          <div>
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif font-medium text-[#1F2D3D]">
              Our Expertise
            </h2>
          </div>
            ...
            return (
              ...
              >
                ...
                <div className="z-10 text-[#FAF8F5] relative flex items-center justify-between opacity-80 group-hover:opacity-100 transition-opacity">
                  <span className="text-xs uppercase font-sans font-semibold text-[#F1C453]">
                    0{index + 1}
                  </span>
